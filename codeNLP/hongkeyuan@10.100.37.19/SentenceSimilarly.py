...
from MyCode.Algorithm import LDA_Topic
import pickle
import random
...
class SentenceSimilarlyObj(object):
	...
	def setSimilar(self,simi_name = "-Similarity-index",corpus=None):
	...
	def save(self,model_name = "simi_sentence_1",word_dic = "simi_word_dic_1"):
	...
	def load(self,model_name="simi_sentence_1",word_dic = "simi_word_dic_1"):
		file = config.ModelPath + model_name + ".model"
		word_dic_file = config.ModelPath + word_dic + ".model"
		try :
